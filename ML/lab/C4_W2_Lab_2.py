...
# Вы установите среднеквадратичную ошибку (mse) в качестве функции потерь и используете стохастический градиентный спуск (SGD) для оптимизации весов во время обучения. 
